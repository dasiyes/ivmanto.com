  ...
  <div class="privacy-policy-container">
    ...
    <ul>
      ...
      <li>
        ...
        <p>
          ...
          use to access the Website. We may also use these Cookies to test new advertisements,
    ...
    <ul>
      <li>
        ...
        help support and maintain Our Service, to contact You, to advertise on third party websites
    ...
    <ul>
      ...
      <li>
        ...
        the right to to have any incomplete or inaccurate information We hold about You corrected.
      </li>
      <li>
    ...
    <p>
      ...
      Service: <a href="https://www.facebook.com/terms.php">https://www.facebook.com/terms.php</a>
    </p>
    <p>
      Visit the Facebook Privacy Policy
      <a href="https://www.facebook.com/policy.php">https://www.facebook.com/policy.php</a> for more
      information about how Facebook manages Personal data or contact Facebook online, or by mail:
      Facebook, Inc. ATTN, Privacy Operations, 1601 Willow Road, Menlo Park, CA 94025, United
      States.
    </p>
    ...
    <p>
      ...
      Page. Each Cookie contains a unique identifier code and remains active for a period of two
    ...
    <p>
      ...
      and 18 years old. In some cases, this means We will be unable to provide certain functionality
      of the Service to these users.
    </p>
    <p>
