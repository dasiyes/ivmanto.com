    ...
    <div class="container mx-auto px-6 grid md:grid-cols-2 gap-12 items-center">
      ...
      <div>
        ...
        <p class="text-lg text-gray-600 mt-6">
          ...
          Platform. My passion is helping businesses unlock the true value of their data. I focus on
          building solutions that are not just technologically sound, but also align perfectly with
          your business goals.
        </p>
